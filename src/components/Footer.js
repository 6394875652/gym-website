            ...
            <div className="footer container-fluid mt-5 py-5 px-sm-3 px-md-5 text-white">
                <div className="row pt-5">
                    <div className="footer-nav col-lg-3 col-sm-6 mb-5 ps-sm-5 ps-lg-0">
                        ...
                        <p><i className="fa fa-map-marker-alt me-2"></i>123 Street, New Delhi, INDIA</p>
                        <p><i className="fa fa-phone-alt me-2"></i>+91 8879967890</p>
                ...
                <div className="container border-top border-dark pt-5">
                    <p className="m-0 text-center text-white">
                        ...
                        <Link className="text-white fw-bold text-decoration-none" to="/"> Anand kumar</Link>
                    </p>
                </div>
            </div>
