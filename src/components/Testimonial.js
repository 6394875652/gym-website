...
import testimonial1 from '../assests/image/testimonial-1.jpg'
import testimonial2 from '../assests/image/testimonial-2.jpg'
import testimonial3 from '../assests/image/testimonial-3.jpg'
                                ...
                                <div className="carousel-inner" role="listbox">
                                    <div className="carousel-item active">
                                        <div className="d-flex align-items-center mb-4 text-white">
                                            <img className="rounded-circle bg-dark p-2 img-fluid" src={testimonial1} alt="Gym logo" />
                                            <div className="ps-4">
                                                <h4>Client Name</h4>
